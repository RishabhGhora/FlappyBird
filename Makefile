...
OFILES = gba.o font.o game.o draw.o logic.o images/garbage.o images/startScreen.o images/ground.o images/bird.o images/pipe.o images/pipedown.o images/end.o
